...
" =============================================================================
autocmd! bufwritepost _vimrc source% "自动加载
" -----------------------------------------------------------------------------
...
set autochdir                " 设定文件浏览器目录为当前目录 自动切换当前目录为当前文件所在的目录
set nowrap                   " 设置不自动换行
...
let g:vimrc_author='Coola'
let g:vimrc_email='lcy@gmail.com'
let g:vimrc_homepage='everrwhere'
